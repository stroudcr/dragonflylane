...
const PostCard = ({ post }) => (
  ...
  <div className="p-0 pb-12 mb-8 bg-white rounded-lg shadow-lg cursor-pointer lg:p-8">
    ...
    <h1 className="mb-8 text-3xl font-semibold text-center transition duration-700 hover:text-pink-600">
      {post.title}
    </h1>
    ...
    <div className="text-center">
      <Link href={`/post/${post.slug}`}>
        <span className="inline-block px-8 py-3 text-lg font-medium text-white transition duration-500 transform bg-pink-600 rounded-full ease hover:-translate-y-1">Continue Reading</span>
      </Link>
    </div>
  </div>
  </Link>
